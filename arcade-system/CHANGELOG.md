...
### Fixed
- اجرای دقیق قوانین حرکت Rook برای جلوگیری از حرکت‌های مورب یا عبور از روی مهره‌های مسدودکننده و هم‌تراز شدن با هایلایت‌های مجاز.
- اجرای صحیح قوانین ترکیبی Gryphon (حرکت مورب سپس راست‌خط) برای جلوگیری از مسیرهای نامعتبر.
- همگام‌سازی اعتبارسنجی حرکت با هایلایت‌ها تا مربع‌های غیرمجاز در UI برجسته نشوند.

### Improved
- بهبود پایداری منطق شطرنج با تمرکز بر سازگاری قوانین و کنترل خطا در اعتبارسنجی حرکت.
...
### نسخه 1.0.0
- **علیرضا زارع بیدکی** (@alireza-zarebidoki) - توسعه‌دهنده اصلی
